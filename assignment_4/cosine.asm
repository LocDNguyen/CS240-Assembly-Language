;****************************************************************************************************************************
; Program name: "cosine". This program takes a float input and converts it to it's cosine counterpart.                      *
...
;   Output parameter: Cosine counterpart of inputted number
;
; Assemble: nasm -f elf64 -o cosine.o -l cosine.lis cosine.asm
;
...
; Current (first) term of maclaurin series is 1.0
mov rax, 1
cvtsi2sd xmm14, rax
