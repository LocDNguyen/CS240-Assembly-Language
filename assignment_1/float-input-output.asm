...
input1prompt db "Please input 1 floating point number and press enter. ", 10, 0
input2prompt db "Please enter two float numbers separated by white space. Press enter after the second input. ", 10, 0
input3prompt db "Please enter three float numbers separated by white space. Press enter after the thrid input. ", 10, 0
